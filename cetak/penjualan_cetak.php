...
<html>
<head>
<title> :: Nota Penjualan - MX Komputer</title>
...
<!--  <tr>
    <td colspan="2"><code><strong>No.  </strong></code></td>
    <td align="right"><code>:</code></td>
...
<table class="table" width="742" border="0" cellspacing="1" cellpadding="2">
 ...
 <!--   <td width="66" align="center" bgcolor="#F5F5F5"><code><strong>Disc</strong></code></td> -->
	...
	//	$hargaDiskon= $notaData['harga_jual'] - ( $notaData['harga_jual'] * $notaData['diskon'] / 100 );
		...
		$totalBayar2 = $totalBayar + $kolomData['harga_service'];
