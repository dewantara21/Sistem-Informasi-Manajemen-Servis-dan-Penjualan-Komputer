...
<div class="row-fluid">
	<div class="span12">
<h3 class="header smaller lighter blue">DATA KATEGORI</h3>
<a href="?page=Kategori-Add" target="_self"><div class="table-header">ADD DATA</div></a>
   <table id="sample-table-2" class="table table-striped table-bordered table-hover">
   <thead>
      <tr>
        <th width="30" ><b>No</b></th>
        <th width="530"><b>Nama Kategori </b></th>
	...
	?>
      <tr>
		...
		<a href="?page=Kategori-Edit&Kode=<?php echo $Kode; ?>" target="_self" alt="Edit Data" class="icon-edit bigger-120" title="Edit"></a></td>
        <td width="44" align="center">
		<a href="?page=Kategori-Delete&Kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data" title="Delete" class="icon-trash bigger-120" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA KATEGORI INI ... ?')">
			 </a></td>
      </tr>
      <?php } ?>
    </table>
