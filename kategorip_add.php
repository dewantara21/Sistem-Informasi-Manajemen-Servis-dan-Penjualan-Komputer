...
if(isset($_POST['btnSimpan'])){
	...
	$cekSql="SELECT * FROM kategori_perangkat WHERE nm_kategori='$txtNama'";
	...
	if (count($pesanError)>=1 ){
		...
		$kodeBaru	= buatKode("kategori_perangkat", "K");
		$mySql	= "INSERT INTO kategori_perangkat (kd_kategori, nm_kategori) VALUES ('$kodeBaru','$txtNama')";
...
$dataKode	= buatKode("kategori_perangkat", "K");
$dataNama	= isset($_POST['txtNama']) ? $_POST['txtNama'] : '';
?>
<form id="myForm" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
<table class="table-list" width="100%">
	<tr>
	  <th colspan="3"><div align="left">TAMBAH KATEGORI PERANGKAT </div></th>
	</tr>
	<tr>
