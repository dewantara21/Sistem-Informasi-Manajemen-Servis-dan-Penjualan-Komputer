...
if (trim($_POST['txtTanggal'])!=date('d-m-Y') xor trim($_POST['txtTanggal'])==$dates xor trim($_POST['txtTanggal'])==$dates2 xor trim($_POST['txtTanggal'])==$dates3 ) {
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "INSERT INTO services (kd_pelanggan,teknisi,nm_kategori, tgl_service, nama_brg, deskripsi, step) 
					VALUES ('$txtKodePelanggan',
					        '$cmbTeknisi',
					        '$cmbPerangkat',
							'".InggrisTgl($_POST['txtTanggal'])."',
							'$txtBarang',
							'$txtDeskripsi',
							'ON PROSES')";
...
$dataKodePelanggan	= isset($_POST['txtKodePelanggan']) ? $_POST['txtKodePelanggan'] : '';
$dataTanggal = isset($_POST['txtTanggal']) ? $_POST['txtTanggal'] : date('d-m-Y');
$dataDeskripsi= isset($_POST['txtDeskripsi']) ? $_POST['txtDeskripsi'] : '';
$dataBarang= isset($_POST['txtBarang']) ? $_POST['txtBarang'] : '';
$dataTeknisi	= isset($_POST['cmbTeknisi']) ? $_POST['cmbTeknisi'] : ' ';
$dataPerangkat	= isset($_POST['cmbPerangkat']) ? $_POST['cmbPerangkat'] : ' ';
...
<h3 class="header smaller lighter blue">TAMBAH DATA SERVIS</h3></div></div>
   ...
   <tr>
	...
	<tr>
	  ...
	  <td><b>:</b></td>
	  <td><input type="text" name="txtTanggal" value="<?php echo $dataTanggal; ?>"  class="date-picker" id="id-date-picker-1" data-date-format="dd-mm-yyyy"/></td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td><b>:</b></td>
	  <td><input type="text" name="txtBarang" size="20" maxlength="40"  title="Perangkat Tidak Boleh Kosong" class="required" value="<?php echo $dataBarang; ?>" /></td>
    </tr>
	<tr>
