...
$dataKategori	= isset($_POST['cmbKategori']) ? $_POST['cmbKategori'] : 'SEMUA';
...
<div class="row-fluid">
	<div class="span12">
<h3 class="header smaller lighter blue">LAPORAN DATA BARANG PER KATEGORI</h3>
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table width="500" border="0"  class="table-list">
    <tr>
      <td width="120"><b>Nama Kategori </b></td>
      <td width="5"><b>:</b></td>
      <td width="361"><select name="cmbKategori">
...
<thead>
 ...
 <!--   <th><strong>Barcode</strong></th> -->
  ...
  <?php
	# SQL Menampilkan data barang per Kategori
	$mySql 	= "SELECT barang.* FROM barang $filterSQL ORDER BY kd_barang ASC LIMIT $hal, $row";
