...
if(isset($_POST['btnSimpan'])){
	...
	$cekSql="SELECT * FROM kategori_perangkat WHERE nm_kategori='$txtNama' AND NOT(nm_kategori='".$_POST['txtLama']."')";
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "UPDATE kategori_perangkat SET nm_kategori='$txtNama' WHERE kd_kategori ='".$_POST['txtKode']."'";
...
$mySql	 = "SELECT * FROM kategori_perangkat WHERE kd_kategori='$Kode'";
...
<table class="table-list" width="100%">
	<tr>
	  <th colspan="3">UBAH KATEGORI PERANGKAT </th>
	</tr>
	<tr>
	  <td width="15%"><b>Kode Kategori Perangkat</b></td>
	  <td width="1%"><b>:</b></td>
	...
	<tr>
	  <td><b>Nama Kategori Perangkat</b></td>
	  <td><b>:</b></td>
